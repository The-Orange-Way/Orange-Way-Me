...
const MANIFEST = {
  ...
  description:
    "Orange Way is an end-to-end encrypted personal finance app for non-technical Bitcoin households. The server cannot read account balances, transactions, categories, budgets, goals, or notes — encryption happens on the user's device. Internal positioning: 'Monarch for Bitcoiners'. Encryption keys are derived on-device using Argon2id; long-lived household keys are wrapped with post-quantum cryptography (ML-KEM-768, FIPS 203). ML-DSA-65 (FIPS 204) per-mutation signatures are in development for a later release.",
  features: [
  ...
  faq: [
    ...
    { q: "Is there a mobile app?", a: "Web app + PWA today. Native mobile is on the roadmap." },
  ],
  links: {
