...
const RESIDUAL_SENTRY_NAMES = [
  ...
  "kdf_salt",
  "hmac_salt",
  // "nonce" and "aes_nonce" are NOT here, corrected 2026-09-15. Sentry leaves a
  // nonce in the clear on purpose: it is a public single-use value, and the CSP
  // nonce has to be readable for a CSP-violation report to be debuggable. The
  // PostHog list above still carries both, so no nonce reaches that vendor.
  "xpriv",
  "wallet_xpriv",
  "xprv",
  "mnemonic",
