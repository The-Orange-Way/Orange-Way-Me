 ...
 * at dev HEAD when this was extracted.
 *
 ...
 * handler, the token-expiry guard, the independent scanned/saved counts)
 * moved with it: see __tests__/handle-stealth-sync-wiring.test.ts in this
 * directory.
 */
import { toast } from "sonner";
import type { MutableRefObject } from "react";
import { mintWidgetSession } from "@/lib/or/widget";
...
export interface HandleStealthSyncDeps {
  ...
  channelRef: MutableRefObject<StealthSyncHandle | null>;
