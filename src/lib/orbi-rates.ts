 ...
 * for "the full matrix for a date range" is the same request every OWM
 * client makes, while a request for one exact bucket_ts is a fingerprint of
 * that one transaction (see OWM-T0159's ZKA constraint section). No account,
