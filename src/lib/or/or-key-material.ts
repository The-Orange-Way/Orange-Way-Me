...
export const OR_UNPINNED_SALT_ROTATED_REASON =
  "Orange Rails key material was never pinned for this account and the vault salt has just changed, so the key that opened existing rows cannot be reproduced. Please contact support to restore access.";
